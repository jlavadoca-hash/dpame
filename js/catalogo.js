...
function renderProducts(products) {
    ...
    products.forEach(product => {
        ...
        let tagHtml = '';
        if (BESTSELLER_IDS.includes(product.id)) {
            tagHtml = '<span class="product-tag">Best Seller</span>';
...
window.openCustomizationModal = function(productId) {
    ...
    const up1 = document.getElementById('imageUpload1'); 
    if(up1) up1.value = '';
...
// ==========================================
// 4. SUBIDA DE IMÁGENES Y DRAG & DROP
// ==========================================
