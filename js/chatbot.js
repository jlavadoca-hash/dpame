// Chatbot Inteligente D'Pame - NLP Básico en Español
class IntelligentChatbot {
    constructor() {
        ...
        // Base de conocimiento con múltiples variaciones
        this.intents = {
            saludo: {
                patterns: [
        ...
        // Entidades para extraer información
        this.entities = {
            numeros: /\b(\d+)\b/g,
    ...
    getPersonalizacionResponse(entities = {}) {
        return "🎨 <strong>Personalización Total:</strong><br><br>" +
            ...
            "1️⃣ Selecciona tu producto favorito<br>" +
            "2️⃣ Elige color, talla y material<br>" +
            "3️⃣ Sube tu diseño o logo (PNG, SVG, PDF)<br>" +
            "4️⃣ ¡Nosotros nos encargamos del resto!<br><br>" +
    ...
    getMetodosPagoResponse() {
        return "💳 <strong>Métodos de Pago:</strong><br><br>" +
            ...
            "💳 <strong>Tarjetas:</strong> Visa, Mastercard, Amex (vía Stripe)<br>" +
            "🏦 <strong>Transferencia bancaria:</strong> Internacional o local<br>" +
            "📱 <strong>WhatsApp Business:</strong> Para pedidos corporativos<br>" +
            "💵 <strong>Contra entrega:</strong> Solo Bogotá (pedidos >100 uds)<br><br>" +
            "<strong>Seguridad:</strong><br>" +
            "✓ Pagos 100% seguros encriptados<br>" +
            "✓ No almacenamos datos de tarjetas<br>" +
            "✓ Confirmación inmediata por email<br><br>" +
            "<strong>Condiciones:</strong><br>" +
            "• 50% anticipo para confirmar pedido<br>" +
            "• 50% restante antes del envío<br>" +
